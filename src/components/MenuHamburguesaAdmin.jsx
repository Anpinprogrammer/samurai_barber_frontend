        ...
        <div className='relative md:hidden'>
            ...
            <div className={`fixed top-0 right-0 h-full w-64 bg-white/80 shadow-lg transform ${ abierto ? 'translate-x-0' : 'translate-x-full' } transition-transform duration-300 ease-in-out lg:hidden z-50`}>
                ...
                <nav className="flex justify-start flex-col gap-4 ml-5 font-mont font-bold">
                    <Link to="home" smooth={true} duration={500} className="text-black hover:text-gray-400 text-lg cursor-pointer transition">Soy Admin</Link>
                    <Link to="servicios" smooth={true} duration={500} className="text-black hover:text-gray-400 text-lg cursor-pointer transition">Soy Barbero</Link>
